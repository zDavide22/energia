                        ...
                        <tbody>
                            @foreach ($data as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <form action="{{ Route('Bollette') }}" method="POST" class="mt-4">
                                            @csrf
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center">
                                            <form action="{{ Route('removeCon') }}" method="POST" class="mt-4">
                                                @csrf
                                                <input type="text" name="id" class="hidden" value="{{ $item->id }}">
                                                <button type="submit"
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                ...
                                <tr>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center">
                                            <p class="text-gray-900 whitespace-no-wrap">{{ $item->mcgas }}</p>
                                        </div>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center">
...
>
  <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100">
    ...
    >
      ...
      <form action="{{ Route('letturaGrafico') }}" method="POST">
        @csrf

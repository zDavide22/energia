<nav x-data="{ open: false }" class="bg-gray-800 border-gray-100" style="margin:">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-400 hover:text-white hover:border-gray-300 focus:outline-none focus:text-gray-500 focus:border-gray-700 transition duration-150 ease-in-out">

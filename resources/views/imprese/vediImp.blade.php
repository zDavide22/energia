<x-imprese-layout>
    <br><br><form action="{{ route('scaricaImp') }}" method="POST">
    @csrf
            ...
            <div class=" md:mx-auto bg-white text-black rounded-lg relative min-w-0 break-words overflow-hidden shadow-lg mb-4 md:w-2/3 bg-white dark:bg-gray-900">
                <div class="px-6 py-6 relative">
                    ...
                    <div class="block sm:flex justify-between items-center flex-wrap ml-10 md:ml-20">
                        ...
                        <div class="w-full sm:w-full">
                            <div class="flex mb-2 justify-between items-center"><span>Tipologia di cliente: Impresa</span></div>
                        </div>
                        <div class="w-full sm:w-full">
                            <div class="flex mb-2 justify-between items-center"><span>Ragione Sociale: {{ $cliente->ragSociale }}</span></div>
                        </div>
                        <div class="w-full sm:w-full">
                            <div class="flex mb-2 justify-between items-center"><span>Partita IVA: {{ $cliente->pIVA }}</span></div>
                        </div>
                        <div class="w-full sm:w-full">
    ...
    <form action="{{ route('indietroI') }}" method="POST">
        @csrf

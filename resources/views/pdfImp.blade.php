                ...
                <div class="bg-white text-black rounded-lg relative break-words overflow-hidden shadow-lg mb-4 bg-white dark:bg-gray-900">
                    <div class="px-6 py-6 relative">
                        ...
                        <div class="block sm:flex justify-between items-center flex-wrap ml-20">
                            ...
                            <div class="w-full sm:w-full">
                                <div class="flex mb-2 justify-between items-center"><span>Ragione Sociale: {{ $dataI['cliente']['ragSociale'] }}</span></div>
                            </div>
                            <div class="w-full sm:w-full">
                                <div class="flex mb-2 justify-between items-center"><span>Partita IVA: {{ $dataI['cliente']['pIVA'] }}</span></div>
                            </div>
                            <div class="w-full sm:w-full">
